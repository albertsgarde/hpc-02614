...
double
gauss_seidel_inner_par3(double ***u, double ***f, const int N) {
...
int
gauss_seidel_par3(double ***u, double ***f, const int N, const int iter_max, const double threshold) {
    int iter = 0;
    ...
    while (delta_norm > threshold && iter < iter_max) {
        double _delta = gauss_seidel_inner_par3(u, f, N);
