...
void jacobi_inner_ser(double ***u, double ***old_u, double ***f, const int N) {
...
int jacobi_ser(double *** u, double *** old_u, double ***f, const int N, const int iter_max, const double threshold) {
    int iter = 0;
